  ...
  return (
    <div className="w-auto h-max text-white text-sm bg-zinc-800 grid grid-cols-2 sm:grid-cols-3 py-1">
      <div className="h-full flex items-center justify-evenly text-zinc-100">
        <a
          href="https://www.youtube.com/channel/UCs1PNpqKxQKGbWZpGZbeJGQ"
        ...
        <a
          href="https://www.instagram.com/whatsgoodie_21/"
          className="w-max h-max"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://soundcloud.com/goodie-201453211"
          className="w-max h-max"
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <div className="h-full flex justify-center items-center">
        ...
        <a
          href="https://hunterlauder9601.github.io/"
          className="ml-1"
          target="_blank"
          rel="noopener noreferrer"
        >
